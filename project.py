    ...
    def edit_data_for_day(self: object):
        ...
        while True:
            try:
                ...
                self.calendar_data[str(day_select)] = [new_data]
                break
            except ValueError:
...
def print_available_calendars(delete=False) -> object:
    ...
    :param delete: flag to adjust the message to delete instread of load in read_json()
    :type delete: bool
...
def read_json(silent="n", selector="", delete=False) -> object:
    """
...
def get_calendar_name(adCalendar) -> object:
    """
    A function to prompt the user for calendar name to create a calendar
    Validates uniquness using is_calendar_name_uniqe()
    Sets a valid calendar name.
    :param adCalendar: A calendar object
    :type adCalendar: object
    :return: A Calendar object's name
    :rytep: str
    """
    while True:
...
def get_calendar_year_and_month(adCalendar) -> str:
    """
    A function to prompt the user for calendar month and year
    Validates input using setter methods in class Calendar
    returns the valid years and month
    :param adCalendar: A calendar object
    :type adCalendar: object
    :return: A Calendar's validate yead and month
    :rytep: str
    """
...
def get_calendar_days(year: str, month: str, adCalendar: object):
    """
    Gets user input to create a new calendar. Validates given input (y/N) and how many days should the calendar run?.
    Defaults to standard amount of days in month if needed.
    Reprompts if needed.
    :param month: a valid month
    :param year: a valid year
    :param adCalendar: an object of class Calendar
    :type year: str
    :type month: str
    :type adCalendar: object
    """
...
def get_calendar_input(adCalendar: object):
    ...
    Calls on a multitude of functions.
